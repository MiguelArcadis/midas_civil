...
def midas_parser(elements_to_extract, combs_to_extract, element_parts_to_extract):
	...
	windows = pwa.Desktop(backend="uia").windows()
	...
	app = pwa.application.Application().connect(title=midas_title)
	...
	keyboard.send_keys('{VK_RIGHT}{VK_RIGHT}{VK_RIGHT}{VK_RIGHT}{VK_RIGHT}{VK_RIGHT}{VK_RIGHT}')
	keyboard.send_keys('{VK_DOWN}')
	keyboard.send_keys('{VK_RIGHT}{VK_RIGHT}{VK_RIGHT}{VK_RIGHT}{VK_RIGHT}{VK_RIGHT}{VK_RIGHT}{VK_RIGHT}{VK_RIGHT}{VK_RIGHT}')
	keyboard.send_keys('{ENTER}')
	keyboard.send_keys('{VK_DOWN}{VK_DOWN}{VK_DOWN}{VK_DOWN}{VK_DOWN}{VK_DOWN}{VK_DOWN}{VK_DOWN}{VK_DOWN}{VK_DOWN}{VK_DOWN}')
	keyboard.send_keys('{ENTER}')
	...
	column_names = ["Element", "Load", "Node", "Component", "Axial (kN)", "Shear-y (kN)", "Shear-z (kN)", "Torsion (kN*m)", "Moment-y (kN*m)", "Moment-z (kN*m)"]
...
df_out = pfr.extract_elink_results_per_combination(df_midas_results, FORCES_TO_EXTRACT)
